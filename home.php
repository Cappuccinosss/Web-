    ...
    <div class="row row-cols-2 row-cols-md-4 g-4">
      <div class=" col filter-item all new ">
        <div class="card h-100">
          <img src="img/Airjordan.jpg" class="card-img-top shop-item-image" alt="...">
          <div class="card-body">
      ...
      <div class=" col filter-item all new">
        <div class="card h-100">
          ...
          <div class="card-body d-flex flex-column">
            <h5 class="card-title shop-item-title">Jordan 1 High OG Spider-Man Across The Spider-Verse</h5>
      ...
      <div class=" col filter-item all new">
        <div class="card h-100">
          <img src="img/Black.jpg" class="card-img-top shop-item-image" alt="...">
          <div class="card-body">
      ...
      <div class=" col filter-item all new">
        <div class="card h-100">
          <img src="img/Jordan.jpg" class="card-img-top shop-item-image " alt="...">
          <div class="card-body">
      ...
      <div class=" col filter-item all office-wear ">
        <div class="card h-100">
          <img src="img/nike-tech.jpg" class="card-img-top shop-item-image" alt="...">
          <div class="card-body">
      ...
      <div class=" col filter-item all office-wear">
        <div class="card h-100">
          <img src="img/rmjersey.jpg" class="card-img-top shop-item-image" alt="...">
          <div class="card-body">
      ...
      <div class=" col filter-item all office-wear">
        <div class="card h-100">
          <img src="img/bcjersey.jpg" class="card-img-top shop-item-image" alt="...">
          <div class="card-body">
      ...
      <div class=" col filter-item all office-wear">
        <div class="card h-100">
          <img src="img/atmjersey.jpg" class="card-img-top shop-item-image" alt="...">
          <div class="card-body">
            <h5 class="card-title shop-item-title">Atletico Madrid.jpg</h5>
      ...
      <div class=" col filter-item all offers">
        <div class="card h-100">
          <img src="img/lkjersey.jpg" class="card-img-top shop-item-image" alt="...">
          <div class="card-body">
            <h5 class="card-title shop-item-title">Lakers jersey</h5>
            <p class="card-text shop-item-price">3690.00THB</p>
            <button type="button" style="width: 100%;" class="btn btn-primary mt-auto shop-item-button"><i class="fa-solid fa-cart-shopping " style="margin-right: 4%;"></i>Add To Cart</button>
          </div>
        </div>
      ...
      <div class=" col filter-item all offers">
        <div class="card h-100">
          <img src="img/store.jpg" class="card-img-top shop-item-image" alt="...">
          <div class="card-body">
      ...
      <div class=" col filter-item all offers">
        <div class="card h-100">
          <img src="img/addidas.jpg" class="card-img-top shop-item-image" alt="...">
          <div class="card-body">
